...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_2.setContentsMargins(-1, 5, 0, 0)
        ...
        self.groupBox_2.setMinimumSize(QSize(345, 80))
        self.groupBox_2.setMaximumSize(QSize(345, 80))
        ...
        self.label_22.setMinimumSize(QSize(85, 0))
        ...
        self.dockWidget.setMinimumSize(QSize(0, 0))
        self.dockWidget.setBaseSize(QSize(0, 0))
        self.splitter.addWidget(self.dockWidget)
        self.tableView_df = QTableView(self.splitter)
        ...
        self.tableView_df.setMinimumSize(QSize(0, 0))
        self.tableView_df.setMaximumSize(QSize(16777215, 16777215))
        self.tableView_df.setBaseSize(QSize(0, 0))
        self.tableView_df.setSelectionBehavior(QAbstractItemView.SelectRows)
        self.splitter.addWidget(self.tableView_df)

        self.horizontalLayout_5.addWidget(self.splitter)

        self.verticalLayout = QVBoxLayout()
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(-1, 5, 0, 0)
        ...
        self.verticalLayout_3.setContentsMargins(-1, 5, 0, 0)
        ...
        self.horizontalSpacer_2 = QSpacerItem(765, 17, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_22.setText(QCoreApplication.translate("MainWindow", u"SMA : Short", None))
