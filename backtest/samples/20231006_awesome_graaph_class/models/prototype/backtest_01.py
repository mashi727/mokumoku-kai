...
atr_period = 3
arr["ATR"] = talib.ATR(np.array(arr['High']), np.array(arr['Low']), np.array(arr['Close']), timeperiod=atr_period)
#arr[['ATR']].tail(3)
...
bt = Backtest(arr, My_Strategy, cash=10_000, commission=.002)
stats = bt.run()
print(stats)
